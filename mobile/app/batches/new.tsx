...
import { View, Text, TextInput, Pressable, ScrollView, Modal, FlatList, StyleSheet } from 'react-native';
...
type SelectOption = { id: string; label: string; sublabel?: string | null };
    ...
    <>
      ...
      >
        <Text style={selected ? styles.selectValue : styles.selectPlaceholder}>
          {selected ? selected.label : options.length === 0 ? emptyHint : placeholder}
        </Text>
          ...
          <View style={styles.modalSheet}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  <Text style={[styles.modalOptionText, item.id === selectedId && styles.modalOptionTextActive]}>
                    {item.label}
                  </Text>
