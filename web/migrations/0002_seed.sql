...
INSERT INTO articles (slug, title, excerpt, body_html, cover_url, section, status, published_at, sort) VALUES
(
...
-- do kategórií Štúdio / Wellness / Exteriér (rovnako ako filter na pôvodnej stránke).
-- Súbory stiahne `npm run assets` do public/assets/img/gallery/.
INSERT INTO gallery_images (url, r2_key, alt, category, sort) VALUES
